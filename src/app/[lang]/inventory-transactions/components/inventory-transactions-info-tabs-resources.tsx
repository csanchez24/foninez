  ...
  return (
    <div className="flex items-center justify-between">
      <div className="flex flex-1 items-center space-x-2">
        <Input
          placeholder={
            dictionary.inventoryTransaction.info.tableResource.toolbar.searchFilter.input.placeholder
          }
...
function InventoryTransactionsTabsInventoryTable({
  data,
  isInitialLoading,
    ...
    () => [
      {
        ...
        header: (props) => (
          <DataTableHeadWithSorting
            title={dictionary.inventoryTransaction.info.tableResource.columns.name}
            {...props}
          />
        ),
        cell: ({ row }) => (
      ...
      },
      {
        ...
        header: (props) => (
          <DataTableHeadWithSorting
            title={dictionary.inventoryTransaction.info.tableResource.columns.qty}
            {...props}
          />
        ),
        cell: ({ row }) => (
...
export default function InventoryTransactionsTabsActivities({
  inventoryTransaction,
}: {
  ...
  return (
    <div>
      <div className="py-4">
        <InventoryTransactionsTabsInventoryTable
          data={inventoryTransaction?.inventoryTransactionLines ?? []}
        />
      </div>
    </div>
  );
